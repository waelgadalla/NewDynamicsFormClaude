using DynamicForms.Core.V3.Services;
using DynamicForms.Core.V3.Validation;
using Microsoft.Extensions.DependencyInjection;

namespace DynamicForms.Core.V3.Extensions;

/// <summary>
/// Extension methods for registering DynamicForms.Core.V3 services with dependency injection
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds all DynamicForms.Core.V3 services to the service collection.
    ...
    /// <summary>
    /// Adds DynamicForms.Core.V3 services with the option to register a custom repository implementation.
