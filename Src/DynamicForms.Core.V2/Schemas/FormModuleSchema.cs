...
public record FormModuleSchema
{
    ...
    /// <summary>
    /// Groups of fields where at least one must be filled (e.g., ["email,phone,fax"])
    /// Each string contains comma-separated field IDs
    /// </summary>
    public string[]? OneOfRequiredGroups { get; init; }

    /// <summary>
    /// Field IDs that should be validated as numeric values
    /// </summary>
    public string[]? NumericFieldIds { get; init; }

    /// <summary>
    /// Field IDs that should be validated as date values
    /// </summary>
